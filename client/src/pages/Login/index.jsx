  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        sessionStorage.setItem('auth', JSON.stringify({ username, email, role, accessToken, id }));
      ...
      <div className='container px-6 py-12 h-full max-w-screen-xl'>
        <div className='flex justify-center items-center flex-wrap h-full g-6 text-gray-800'>
          <div className='md:w-8/12 lg:w-6/12 mb-12 md:mb-0'>
            <img alt='LoginImage' src={loginSvg} className='w-full' />
          </div>
            ...
            >
              <div className='mb-6'>
                ...
                {loginError.type === 'username' && loginError.show ? (
                  <div className='text-red-500 text-sm'>{loginError.message}</div>
                ) : null}
              </div>
